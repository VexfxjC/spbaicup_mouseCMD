...
DebugCommand::Add::Add(model::DebugData data) : data(data) { }

// Read Add from input stream
DebugCommand::Add DebugCommand::Add::readFrom(InputStream& stream) {
    model::DebugData data = model::DebugData::readFrom(stream);
    return DebugCommand::Add(data);
}
...
bool DebugCommand::Add::operator ==(const DebugCommand::Add& other) const {
...
DebugCommand::Clear DebugCommand::Clear::readFrom(InputStream& ) {
...
bool DebugCommand::Clear::operator ==(const DebugCommand::Clear& ) const {
    return true;
}
...
DebugCommand::Flush DebugCommand::Flush::readFrom(InputStream& ) {
...
bool DebugCommand::Flush::operator ==(const DebugCommand::Flush& ) const {
    return true;
}
